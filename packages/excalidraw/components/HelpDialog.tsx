      ...
      >
        ...
        <Section title={t("helpDialog.shortcuts")}>
          ...
          >
            ...
            />
            <Shortcut
              label={t("toolBar.parallelogram")}
              shortcuts={[KEYS.G, KEYS["4"]]}
            />
            <Shortcut
            ...
            <Shortcut
              ...
              shortcuts={[KEYS.O, KEYS["5"]]}
            />
            <Shortcut
              label={t("toolBar.capsule")}
              shortcuts={[KEYS.C, KEYS["6"]]}
            />
            <Shortcut
              label={t("toolBar.arrow")}
              shortcuts={[KEYS.A, KEYS["7"]]}
            />
            <Shortcut
              label={t("toolBar.line")}
              shortcuts={[KEYS.L, KEYS["8"]]}
            />
            <Shortcut
